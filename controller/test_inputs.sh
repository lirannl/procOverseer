...
if ./test_controller_args 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args --help 1> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o outfile 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -log logfile 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -t 10 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -t ten 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o outfile -log logfile 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o outfile -t 10 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -log logfile -t 10 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -log logfile -o outfile 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o outfile -log logfile -t 10 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 -o outfile -t 10 -log log file 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 mem lol 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 memkill lol 2> >( grep -q "${HELP_CMD}");
then
...
if ./test_controller_args localhost 8000 memkill "42 .5" 2> >( grep -q "${HELP_CMD}");
then
     echo -e "${GREEN}Test with memkill bad % passed.${NC}"
else
     echo -e "${RED}Test with memkill bad % failed.${NC}"
